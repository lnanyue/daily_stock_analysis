...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "aggregate_report_title": "多股汇总分析报告",
        "stock_label": "股票",
        "core_conclusion_label": "核心结论",
        "confidence_label": "置信度",
        "details_heading": "详情解读",
        "decision_dashboard": "决策仪表盘",
        ...
        "peer_comparison_heading": "同行业横向对比",
        "industry_label": "所属行业",
        "market_cap_label": "总市值",
        "pe_ttm_label": "PE(TTM)",
        "pb_label": "市净率",
        "roe_label": "ROE",
        "revenue_growth_label": "营收增长",
        "profit_growth_label": "净利增长",
        "gross_margin_label": "毛利率",
        "signal_label": "信号",
        "position_sizing_label": "建议仓位",
        "max_label": "最高",
        "entry_plan_label": "入场计划",
        "ideal_entry_label": "理想入场",
        "secondary_entry_label": "次级入场",
        "exit_plan_label": "出场计划",
        "holding_period_label": "预计持有",
        "days_label": "天",
        "risk_reward_label": "风险回报比",
        "rationale_label": "决策理由",
        "sharpe_label": "夏普比率",
        "max_drawdown_label": "最大回撤",
        "annualized_return_label": "年化回报",
        "worst_drawdown_label": "最差回撤",
        "risk_breakdown_label": "风险细分",
        "var_label": "VaR 估算",
        "stress_test_label": "压力测试",
        "correlation_risk_label": "相关性风险",
        "market_risk_label": "市场风险",
        "liquidity_risk_label": "流动性风险",
        "concentration_risk_label": "集中度风险",
        "sentiment_risk_label": "情绪风险",
    },
    "en": {
        ...
        "aggregate_report_title": "Aggregate Analysis Report",
        "stock_label": "Stock",
        "core_conclusion_label": "Core Conclusion",
        "confidence_label": "Confidence",
        "details_heading": "Detailed Interpretation",
        "decision_dashboard": "Decision Dashboard",
        ...
        "peer_comparison_heading": "Industry Peer Comparison",
        ...
        "signal_label": "Signal",
        "position_sizing_label": "Position Sizing",
        "max_label": "Max",
        "entry_plan_label": "Entry Plan",
        "ideal_entry_label": "Ideal Entry",
        "secondary_entry_label": "Secondary Entry",
        "exit_plan_label": "Exit Plan",
        "holding_period_label": "Holding Period",
        "days_label": "days",
        "risk_reward_label": "Risk/Reward",
        "rationale_label": "Rationale",
        "sharpe_label": "Sharpe Ratio",
        "max_drawdown_label": "Max Drawdown",
        "annualized_return_label": "Annualized Return",
        "worst_drawdown_label": "Worst Drawdown",
        "risk_breakdown_label": "Risk Breakdown",
        "var_label": "VaR Estimate",
        "stress_test_label": "Stress Test",
        "correlation_risk_label": "Correlation Risk",
        "market_risk_label": "Market Risk",
        "liquidity_risk_label": "Liquidity Risk",
        "concentration_risk_label": "Concentration Risk",
        "sentiment_risk_label": "Sentiment Risk",
    },
}
