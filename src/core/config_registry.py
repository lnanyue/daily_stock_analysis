...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "FUTU_API_HOST": {
        ...
        "description": "富途牛牛 OpenD 服务地址。需要先安装并启动 OpenD，详见 https://openapi.futunn.com/futu-api-doc/intro/opend.html",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FUTU_API_PORT": {
        ...
        "description": "富途牛牛 OpenD 服务端口，默认 11111。",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "FUTU_UNLOCK_PASSWORD": {
        "title": "Futu Unlock Password",
        "description": "OpenD 解锁密码（如需解锁交易权限）。建议通过环境变量设置，避免明文存储。",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "REALTIME_SOURCE_PRIORITY": {
        ...
        "is_required": False,
        "is_editable": True,
        "default_value": "akshare_em,tencent,akshare_sina,efinance",
        "options": [],
        "validation": {},
        "display_order": 20,
    },
    ...
    "OPENBB_NEWS_ENABLED": {
        "title": "OpenBB News Enabled",
        "description": "Enable OpenBB as an optional company-news source. Requires OpenBB and the selected provider extension to be installed.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OPENBB_NEWS_PROVIDER": {
        "title": "OpenBB News Provider",
        "description": "OpenBB provider for company news, for example yfinance, benzinga, or fmp depending on installed OpenBB extensions and credentials.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OPENBB_FETCHER_ENABLED": {
        "title": "OpenBB Fetcher Enabled",
        "description": "Enable OpenBB as an optional price-data fetcher for history, realtime quote, and stock-name fallback. Requires local openbb plus a compatible provider extension.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OPENBB_FETCHER_PROVIDER": {
        "title": "OpenBB Fetcher Provider",
        "description": "OpenBB provider for price data, for example yfinance, fmp, or intrinio depending on installed OpenBB extensions and credentials.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CUSTOM_WEBHOOK_URLS": {
        ...
        "description": "Comma-separated webhook URLs for custom notifications (e.g. DingTalk, Slack).",
        "category": "notification",
        "data_type": "array",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "AGENT_AUTO_ROUTE_ANALYSIS": {
        "title": "Auto Route Analysis",
        "description": "Keep classic stock analysis as the default, but automatically escalate single-stock reports to the Agent pipeline when the run looks complex (for example: data gaps, dense/risk-sensitive news, or richer A-share intelligence context). `AGENT_MODE=true` still forces all reports through Agent mode.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_ARCH": {
        ...
        "description": "Agent execution architecture. 'single' uses the classic ReAct executor; 'multi' uses the hybrid parallel analysis pipeline.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"label": "Multi Agent (Hybrid)", "value": "multi"},
        ],
        "validation": {},
        "display_order": 60,
    },
    "AGENT_ORCHESTRATOR_MODE": {
        ...
        "description": "Agent orchestration mode. 'quick' uses a fast single-stage analysis; 'standard' uses the hybrid pipeline; 'full' runs Deep Research when needed; 'specialist' routes by skill.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
