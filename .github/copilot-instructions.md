...
- Use `README.md` for getting started, runtime/deployment, and high-level capability summaries; put detailed module behavior and troubleshooting guidance in the appropriate `docs/*.md` file.
